...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [QWRT] = { /* Qwerty */
    ...
    {KC_RSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, FUNC(1), FUNC(1), KC_SPC, KC_LGUI, KC_LALT, KC_LCTL, KC_RSFT}
  },
  [WORK] = { /* Workman P */
  ...
  [MDIA] = { /* Utils */
    ...
    {KC_TRNS,   KC_TRNS,   KC_TRNS, KC_TRNS, KC_BTN2, KC_TRNS, KC_TRNS, KC_BTN1, KC_MS_L,    KC_MS_U,    KC_MS_D, KC_MS_R}
    },
};
