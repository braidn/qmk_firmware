...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = KEYMAP( \
        ...
        KC_FN6,KC_NUBS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,     KC_UP,  KC_PGDN, \
        KC_CAPS,KC_LALT,KC_LGUI,               KC_SPC,           KC_RGUI,KC_RALT,KC_TRNS,     KC_LEFT,KC_DOWN,KC_RGHT \
    ),
    [1] = KEYMAP( \
