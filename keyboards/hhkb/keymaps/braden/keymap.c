...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAVI] = \
    LAYOUT(KC_GRV,  KC_FN0, KC_FN2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_FN0, KC_FN2, \
           KC_TRNS, KC_BTN1,KC_MS_U, KC_FN14,   KC_4,  KC_5, KC_FN16,   KC_BSPC,   KC_INS,   KC_9, KC_FN17,  KC_BTN1,  KC_BTN2,  KC_BSLS, \
           MOD_LCTL, KC_HOME,KC_PGDN, KC_PGUP,KC_END,KC_FN6,  KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_NO,  KC_BSLS,  KC_ENT, \
           KC_BSPC, KC_VOLD,KC_VOLU, KC_NO,  KC_NO, KC_FN15,  KC_HOME,KC_PGDN,KC_PGUP,KC_END, KC_NO, KC_BSPC,KC_TRNS, \
...
const uint16_t PROGMEM fn_actions[] = {
   ...
   [14] = ACTION_MODS_KEY(MOD_LALT, KC_RIGHT),
   [15] = ACTION_MODS_KEY(MOD_LALT, KC_LEFT),
   [16] = ACTION_MODS_KEY(MOD_LGUI, KC_C),
   [17] = ACTION_MODS_KEY(MOD_LGUI, KC_V),
};
